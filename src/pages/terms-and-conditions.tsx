  ...
  return (
    <div className="bg-gradient-to-b from-black to-gray-900 min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-center text-gray-400 italic mb-8">Last updated on 23-07-2024 19:49:00</p>
        <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-md">
          <p className="mb-4 text-gray-300">
            These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between AKHIL RAJU, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
          </p>
          <p className="mb-4 text-gray-300">
            By using our website and availing the Services, you agree that you have read and accepted these Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It is your responsibility to periodically review these Terms to stay informed of updates.
          </p>
          <p className="mb-4 font-semibold text-green-500">The use of this website or availing of our Services is subject to the following terms of use:</p>
          <ol className="list-decimal pl-6 space-y-3 text-gray-300">
            ...
            <li>In case you do not raise a refund claim within the stipulated time, then this would make you ineligible for a refund.</li>
            ...
            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Thiruvengadam, Tamil Nadu</li>
